...
let mockPosts = [
  ...
  { id: 'post-welcome-anxiety', communityId: 'anxiety', userId: 'admin', userName: 'Anvesna Admin', title: 'Welcome to the Anxiety Support Group!', content: 'This is a safe space to share your experiences and find support. We\'re glad you\'re here!', createdAt: new Date().toISOString(), reactions: 10, commentsCount: 1, userAvatar: 'https://placehold.co/40x40.png?text=WA' },
  { id: 'post-welcome-depression', communityId: 'depression', userId: 'admin', userName: 'Anvesna Admin', title: 'Welcome to Depression & Low Mood Support!', content: 'You are not alone. Feel free to share and connect with others who understand.', createdAt: new Date().toISOString(), reactions: 8, commentsCount: 0, userAvatar: 'https://placehold.co/40x40.png?text=WA' },
  { id: 'post-welcome-addiction', communityId: 'addiction', userId: 'admin', userName: 'Anvesna Admin', title: 'Welcome to Addiction & Detox Support!', content: 'This community is here to support you on your recovery journey. Share your thoughts and experiences.', createdAt: new Date().toISOString(), reactions: 7, commentsCount: 0, userAvatar: 'https://placehold.co/40x40.png?text=WA' },
  { id: 'post-welcome-self-growth', communityId: 'self-growth', userId: 'admin', userName: 'Anvesna Admin', title: 'Welcome to the Self-Growth Journey Group!', content: 'Let\'s grow together! Share your goals, challenges, and successes here.', createdAt: new Date().toISOString(), reactions: 12, commentsCount: 2, userAvatar: 'https://placehold.co/40x40.png?text=WA' },
];
