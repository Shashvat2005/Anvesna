        ...
        <div className="space-y-8">
          <section className="relative bg-card p-6 sm:p-10 rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted-foreground text-lg">
                A dedicated space for support, resources, and connection on your journey to recovery and well-being. You
                are not alone.
              </p>
            </div>
          </section>
          ...
          <Card className="shadow-lg">
            <CardHeader>
              ...
              <CardDescription>
                Share your experiences, find encouragement, and connect with others in our Addiction Recovery community.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="shadow-lg">
            <CardHeader>
              ...
              <CardDescription>
                Curated articles, exercises, and tools to aid in your recovery and detox process.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {isLoadingResources ? (
                ...
                <p className="text-muted-foreground text-center py-6">
                  No specific resources found for addiction support at this time. General resources are available in the
                  main library.
                </p>
              )}
            </CardContent>
